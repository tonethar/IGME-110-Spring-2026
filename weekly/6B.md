...
- [Project 2: Infographic Project Plan - Requirements](../documents/p2-project-plan.md)
  - see myCourses dropbox for due date (*it's due before Week 7A*)
- [Project 2: Infographic - Mockup/Draft](../documents/p2-mockup-draft.md)
  - see myCourses for due date/time (*it's due before Week 7B*)
  - we will do an in-class peer review of these drafts
- [Project 2: Infographic - Final Version](../documents/p2-final.md)
  - see myCourses for due date/time (*it's due before Week 8A*)

---

## V. BTW
- The last class meeting prior to Spring Break (*Week 8B - Thursday 3/5/2026*) is *optional* so long as you complete and post the [Week 9 Study Guide: Introduction to Figma & Interaction Design](https://docs.google.com/document/d/1nlwsaJXJozfZu4VocByOHxetIghnsTwGtABZgRNFOCc) *prior* to the start of that class meeting
