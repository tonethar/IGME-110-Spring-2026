...
## I. Homework Assigments
- Project 1 Product Proposal - All done!
- [Week-4 Study Guide: Legal Aspects of media](https://docs.google.com/document/d/1ezzesDLjtFx2NJ8W63XMO4m64qAtYHsxJ0IV_Tr8Jkk)
  - due last night, we will discuss on 5A
- [Week 5 Study Guide - More About Media](https://docs.google.com/document/d/1tOWF5bkUcpgSNVwjfjuHR47QUroePsl4RDsGdylowiM/copy)
  - see myCourses for due date, we will discuss on 5A

---

## II. In-class Exercise - Transmedia "Round Robin"/"Telephone" game

- Your instructor will divide you into groups of three or four students for this exercise (the minimum number of teams required is 4), and assign you a group number. At the end of the group activity, you’ll have a short individual writeup to complete.
- Your instructor will give your group an idea to start with - *don't share the story idea with any other groups!*

### Round 1 - Get Started
- For the first ten minute round, your group will create a 100-word story based on the prompt. After the ten minutes are up, pass your story on to another group. Before you pass the team's paper, write your group number on the top of it.
...
### Group Discussion
- After all four rounds are complete, each group will collect all four versions of your original prompt (text, visual, flow chart, and the final story). As a group, discuss the following questions:
...
### Submission to Slack
- Take photos of all 4 versions of the media that evolved from your group's prompt, and upload the images to Slack by replying to the "Transmedia Assignment Submissions" thread in our 110 Slack channel
...
| --- | --- | --- 
|   [**Week 3A Notes**](3A.md)  |  [**IGME-110 Home**](../) | [**Week 5A Notes**](5A.md)
